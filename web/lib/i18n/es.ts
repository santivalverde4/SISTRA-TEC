const es = {
  ...
  auth: {
    ...
    transporter_phone: 'Teléfono de trabajo',
  ...
  profile: {
    ...
    full_name: 'Nombre Completo',
    phone: 'Teléfono',
    phone_placeholder: 'Ej: +506 8888-8888',
    error_phone_required: 'El teléfono es requerido',
    error_phone_min: 'El teléfono debe tener al menos 8 caracteres',
    error_phone_invalid: 'El teléfono solo puede contener números, +, espacios, - y paréntesis',
    address: 'Dirección',
    address_placeholder: 'Ej: San José, Costa Rica',
    error_address_required: 'La dirección es requerida',
    error_address_min: 'La dirección debe tener al menos 5 caracteres',
    email: 'Correo Electrónico',
